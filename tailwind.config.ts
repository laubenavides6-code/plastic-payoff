  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        display: ["KoHo", "system-ui", "sans-serif"],
      },
      colors: {
        ...
        eco: {
          ...
          "coral-light": "hsl(var(--eco-coral-light))",
      ...
      boxShadow: {
        card: "0 2px 12px -2px hsl(0 0% 0% / 0.06)",
        elevated: "0 8px 24px -4px hsl(0 0% 0% / 0.1)",
        button: "0 4px 12px -2px hsl(152 65% 34% / 0.3)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
